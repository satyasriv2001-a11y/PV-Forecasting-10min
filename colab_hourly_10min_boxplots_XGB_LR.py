...
DRIVE_PATH = "/content/drive/MyDrive/Solar PV electricity/hourly_10min_boxplots_XGB_LR"
...
if len(project1140_files) == 0:
    ...
    for file_idx, data_path in enumerate(project1140_files, 1):
        ...
        # Get the script path
        script_path = os.path.join(os.getcwd(), 'hourly_10min_boxplots_XGB_LR.py')
        ...
        # Run hourly and 10-minute box plots for both XGB and LR
        cmd = [
            'python', script_path,
            '--data-path', data_path,
            '--complexity', 'high',
